...
class FirebaseRegistrerView extends StatefulWidget {
  const FirebaseRegistrerView({super.key});

  @override
  State<FirebaseRegistrerView> createState() => _FirebaseRegistrerViewState();
}

class _FirebaseRegistrerViewState extends State<FirebaseRegistrerView> {
  bool _loading = false;
  String? _erro;
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                obscureText: true,
                validator: (value) =>
              value == null || value.length < 6 ? "Senha ivalida" : null,
              ),
